...
const Header = ({ classes }) => (
  <React.Fragment>
    ...
    <AppBar className={'primary-app-bar'} color={'default'} position={'sticky'} elevation={2} >
      <Toolbar>
    ...
    <AppBar className={'secondary-app-bar'} color={'primary'} position={'sticky'} elevation={0} >
      <Toolbar>
    ...
    <AppBar className={'third-app-bar'} color={'primary'} position={'static'} elevation={0} >
      <Toolbar>
    ...
    <AppBar className={'fourth-app-bar'} color={'primary'} position={'static'} elevation={0} >
...
export default withStyles(stylesFunction)(Header);
